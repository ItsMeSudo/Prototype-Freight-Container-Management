...
export default function ADD_JSON(): JSX.Element {
  ...
  const handleSubmit = async () => {
    ...
    if (!File[0]) return;
      const resp  = await fetch("http://172.16.0.2:3001/api/v2/importjson", {
        method: "POST",
        body: data
      });
      ...
      <div>
        <Card>
          <CardHeader>
            ...
            <CardDescription>You can add your JSON</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid w-full max-w-sm items-center gap-1.5">
              <Label>JavaScript Object Notation</Label>
